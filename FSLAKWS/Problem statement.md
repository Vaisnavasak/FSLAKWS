...
&#x20;      The need is to create a proposed solution that takes very few samples of the user defined keyword. Then, it look for that keyword in the audio and it presents that word along with the timestamp where it was spoken
